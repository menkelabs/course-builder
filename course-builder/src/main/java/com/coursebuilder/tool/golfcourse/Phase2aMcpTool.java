...
/**
 * MCP Tool for Phase2a - Automated Satellite Tracing (replaces manual Inkscape).
 * 
 * Phase2a uses SAM (Segment Anything Model) to automatically extract course features
...
public class Phase2aMcpTool extends MatryoshkaTool {
    ...
    static class Phase2aRunPipelineTool implements Tool {
        ...
        @Override
        public String getName() { return "phase2a_run"; }
        ...
        @Override
        public String getCategory() { return "phase2a"; }
        ...
        public ToolResult execute(Map<String, Object> input) {
            ...
            return ToolResult.success(
                ...
                Map.of(
                    ...
                    "command", "phase2a run " + satelliteImage + " --checkpoint " + checkpoint + " -o " + outputDir
                )
            );
        }
    }
    ...
    static class Phase2aGenerateMasksTool implements Tool {
        ...
        @Override
        public String getName() { return "phase2a_generate_masks"; }
        ...
        public ToolResult execute(Map<String, Object> input) {
            ...
            return ToolResult.success(
                ...
                Map.of(
                    ...
                    "masksGenerated", 150,
                    "command", "phase2a generate-masks " + satelliteImage + " --checkpoint ... -o " + outputDir
                )
            );
        }
    }
    ...
    static class Phase2aClassifyFeaturesTool implements Tool {
        ...
        @Override
        public String getName() { return "phase2a_classify"; }
    ...
    static class Phase2aInteractiveSelectTool implements Tool {
        ...
        @Override
        public String getName() { return "phase2a_interactive_select"; }
    ...
    static class Phase2aGenerateSvgTool implements Tool {
        ...
        @Override
        public String getName() { return "phase2a_generate_svg"; }
    ...
    static class Phase2aExportPngTool implements Tool {
        ...
        @Override
        public String getName() { return "phase2a_export_png"; }
    ...
    static class Phase2aValidateOutputTool implements Tool {
        ...
        @Override
        public String getName() { return "phase2a_validate"; }

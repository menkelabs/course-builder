...
public class GolfCourseTestHarness {
    ...
    class CompleteWorkflowTests {
        ...
        void executeCompleteWorkflow() {
            ...
            ToolResult importSvgResult = blenderMcp.execute(Map.of(
                    ...
                    "parameters",
                    Map.of("courseId", courseId, "svgFile", svgConvertResult.data().get("convertedSvg"))));
            ...
            ToolResult importTerrainResult = blenderMcp.execute(Map.of(
                    ...
                    "parameters",
                    Map.of("courseId", courseId, "terrainObj", exportTerrainResult.data().get("terrainObj"))));
    ...
    class MatryoshkaPatternDemo {
        ...
        void demonstrateProgressiveDiscovery() {
            ...
            level1.suggestedTools().forEach(tool -> System.out.println("   • " + tool.getName() + ": " +
            ...
            level2.suggestedTools().forEach(tool -> System.out.println("   • " + tool.getName()));

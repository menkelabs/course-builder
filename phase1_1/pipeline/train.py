...
# course-builder repo root = parents[2] from phase1_1/pipeline/train.py
_REPO_ROOT = Path(__file__).resolve().parents[2]
DEFAULT_ARCHIVE = _REPO_ROOT / "phase1a" / "resources" / "archive.zip"
...
def train(
    ...
    output_dir: Path = Path("phase1_1_output"),

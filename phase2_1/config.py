"""Configuration for Phase 2.1 SegFormer pipeline."""
...
# Class set aligned with Danish Golf Courses + phase2a features
CLASS_IDS = {
    "background": 0,
    "fairway": 1,
    "green": 2,
...
@dataclass
class Phase21Config:
    """Main config for Phase 2.1."""

    # Paths
    input_image: Optional[Path] = None
    output_dir: Path = field(default_factory=lambda: Path("phase2_1_output"))

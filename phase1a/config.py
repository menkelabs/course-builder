"""
Configuration for Phase 1A pipeline.
"""
...
@dataclass
class Phase1AConfig:
    """Main configuration for Phase 1A pipeline."""
    ...
    output_dir: Path = field(default_factory=lambda: Path("phase1a_output"))
    ...
    @classmethod
    def from_yaml(cls, path: Path) -> "Phase1AConfig":
    ...
    @classmethod
    def from_json(cls, path: Path) -> "Phase1AConfig":
    ...
    @classmethod
    def _from_dict(cls, data: dict) -> "Phase1AConfig":

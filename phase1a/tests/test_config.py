...
class TestPhase1AConfig:
    ...
    def test_from_yaml(self, temp_dir):
        ...
        config = Phase1AConfig.from_yaml(yaml_path)
    ...
    def test_from_json(self, temp_dir):
        ...
        config = Phase1AConfig.from_json(json_path)

...
Coordinates for: 40.105005, -74.2932743
...
center_lat = 40.105005
center_lon = -74.2932743
...
print(f"Center: 40.105005, -74.2932743")
print(f"Size: {half_size * 2}m x {half_size * 2}m (includes buffer)")
print(f"Extent: {bbox_layer.extent().toString()}")
print("=" * 50)
print("")
print("CONTROLS:")
print("  - MOUSE WHEEL: Zoom in/out (map only, box stays in place)")
print("  - DRAG BOX: Move the entire boundary polygon")
print("  - MIDDLE MOUSE or SPACE+DRAG: Pan the map")
print("  - Use Vertex Tool (V key) to adjust individual corners")
print("")
print("You can now adjust the boundary to match the course.")
